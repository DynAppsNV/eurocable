...
patch(Many2XAutocomplete.prototype, {
    ...
    async loadOptionsSource(request) {
        ...
        var raw_result = records.map((x) => (x[1]));
        var quick_create = is_option_set(this.props.nodeOptions.create),
            ...
            m2x_create = this.ir_options["web_m2x_options.create"] === undefined;
        var show_create =
        ...
        var create_edit =
            ...
            create_edit_undef =
                this.props.nodeOptions.create === undefined &&
                this.props.nodeOptions.create_edit === undefined,
            m2x_create_edit_undef = this.ir_options["web_m2x_options.create_edit"] === undefined,
